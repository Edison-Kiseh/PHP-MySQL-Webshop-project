...
<html>
    ...
    <body style="background-color: #030e16; color: white;">
        ...
        <div class="container-trui" id="header-parent-container">
            ...
            <div class="picture">
                <img src="../../images/movies/knightAndDay.png" alt="movie image" class="galery"/><br/>
            </div>

                <div class="contain">
                    <div>
                        <img src="../../images/movies/Knight-and-Day.jpg" alt="movie image" class="movie-image"/><br/>
                    </div>
                    ...
                    <div class="details">
                        ...
                        <h2>Knight and Day</h2>
        
                        <p class="movie-description">June Havens meets Roy Miller, a lethal operative, in an unlikely encounter and gets entangled in his adventures. She falls in love with him and has to figure out if he is a traitor or a good guy.</p>
                        <span>Genre: Action/Adventure/Romance</span><br/>
                        <span>Actors: Cameron Diaz, Peter Sarsgaard, Tom Cruise...</span><br/>
                        <span>Director: James Mangold</span><br/>
                        <span>Release: Jun 23, 2010</span><br/>
                    </div>
                    ...
                    <div class="extra-details">
                        ...
                        <hr/>
                        <a href="https://youtu.be/JGPl86DBNNs" target="_blank" title="Click to watch movie trailer"><button class="button">Trailer</button></a>
                    </div>
                </div>
