...
<html>
    ...
    <body style="background-color: #030e16; color: white;">
        ...
        <div class="container-trui" id="header-parent-container">
            ...
            <div class="picture">
                <img src="../../images/movies/sherlockHolmes.jpg" alt="movie image" class="galery"/><br/>
            </div>

                <div class="contain">
                    <div>
                        <img src="../../images/movies/sherlock-holmes.jpg" alt="movie image" class="movie-image"/><br/>
                    </div>
                    ...
                    <div class="details">
                        ...
                        <p class="movie-description">Detective Sherlock Holmes and his partner, Dr Watson, send Blackwood, a serial killer, to the gallows. However, they are shocked to learn that he is back from the dead and must pursue him again.</p>
                        <span>Genre: Action/Adventure/Crime</span><br/>
                        <span>Actors: Jude Law, Rachel McAdams, Robert Downey Jr...</span><br/>
                        <span>Director: Guy Ritchie</span><br/>
                        <span>Release: Dec 25, 2009</span><br/>
                    </div>
                    ...
                    <div class="extra-details">
                        ...
                        <hr/>
                        <a href="https://youtu.be/J7nJksXDBWc" target="_blank" title="Click to watch movie trailer"><button class="button">Trailer</button></a>
                    </div>
                </div>
