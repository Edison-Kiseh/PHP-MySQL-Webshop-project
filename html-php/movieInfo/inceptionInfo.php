...
<html>
    ...
    <body style="background-color: #030e16; color: white;">
        ...
        <div class="container-trui" id="header-parent-container">
            ...
            <div class="picture">
                <img src="../../images/movies/inception2.jpg" alt="movie image" class="galery"/><br/>
            </div>

                <div class="contain">
                    <div>
                        <img src="../../images/movies/inception.jpg" alt="movie image" class="movie-image"/><br/>
                    </div>
        
                    <div class="details">
                        <div class="mini-info">
                            <div class="hd"><b>HD</b></div>&nbsp;&nbsp;
                            <p class="pg"><b>PG-13</b></p>&nbsp;&nbsp;
                        ...
                        <p class="movie-description">A thief who steals corporate secrets through the use of dream-sharing technology is given the inverse task of planting an idea into the mind of a C.E.O., but his tragic past may doom the project and his team to disaster.</p>
                        <span>Genre: Action/Sci-fi</span><br/>
                        <span>Actors: Leonardo Di Capro, Joseph-Gordon Levitt, Cillian Murphy, Tom Hardy...</span><br/>
                        <span>Director: Christopher Nolan</span><br/>
                        <span>Release: July 21, 2010</span><br/>
                    </div>
        
                    <div class="extra-details">
                        <p class="amount"><b>9.99$</b></p>
                        <button class="button">Add to cart</button>
                        <button class="button">Buy now</button>
                        <hr/>
                        <a href="https://www.youtube.com/watch?v=YoHD9XEInc0" target="_blank" title="Click to watch movie trailer"><button class="button">Trailer</button></a>
                    </div>
                </div>
