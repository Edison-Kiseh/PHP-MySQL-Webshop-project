...
<html>
    ...
    <body style="background-color: #030e16; color: white;">
        ...
        <div class="container-trui" id="header-parent-container">
            ...
            <div class="picture">
                <img src="../../images/movies/the_tourist_movie_image_angelina_jolie_johnny_depp_01.jpg" alt="movie image" class="galery"/><br/>
            </div>

                <div class="contain">
                    <div>
                        <img src="../../images/movies/the_tourist.jpg" alt="movie image" class="movie-image"/><br/>
                    </div>
                    ...
                    <div class="details">
                        ...
                        <p class="movie-description">Revolves around Frank, an American tourist visiting Italy to mend a broken heart. Elise is an extraordinary woman who deliberately crosses his path.</p>
                        <span>Genre: Thriller/Romance</span><br/>
                        <span>Actors: Johnny Depp, Paul Bettany, Angelina Jolie...</span><br/>
                        <span>Director: Florian Henckel von Donnersmarck</span><br/>
                        <span>Release: December 10, 2010</span><br/>
                    </div>
                    ...
                    <div class="extra-details">
                        ...
                        <hr/>
                        <a href="https://youtu.be/5XtbLezJtMg" target="_blank" title="Click to watch movie trailer"><button class="button">Trailer</button></a>
                    </div>
                </div>
