...
<html>
    ...
    <body style="background-color: #030e16; color: white;">
        ...
        <div class="container-trui" id="header-parent-container">
            ...
            <div class="picture">
                <img src="../../images/movies/theMatrix.jpg" alt="movie image" class="galery"/><br/>
            </div>

                <div class="contain">
                    <div>
                        <img src="../../images/movies/the-matrix.jpg" alt="movie image" class="movie-image"/><br/>
                    </div>
                    ...
                    <div class="details">
                        ...
                        <p class="movie-description">Neo, a computer programmer and hacker, has always questioned the reality of the world around him. His suspicions are confirmed when Morpheus, a rebel leader, contacts him and reveals the truth to him.</p>
                        <span>Genre: Sci-Fi/Action</span><br/>
                        <span>Actors: Laurence Fishburne, Keanu Reeves, Carrie-Anne Moss...</span><br/>
                        <span>Director: Lana Wachowski, Lilly Wachowski</span><br/>
                        <span>Release: Mar 31, 1999</span><br/>
                    </div>
                    ...
                    <div class="extra-details">
                        ...
                        <hr/>
                        <a href="https://youtu.be/vKQi3bBA1y8" target="_blank" title="Click to watch movie trailer"><button class="button">Trailer</button></a>
                    </div>
                </div>
