...
<html>
    ...
    <body style="background-color: #030e16; color: white;">
        ...
        <div class="container-trui" id="header-parent-container">
            ...
            <div class="picture">
                <img src="../../images/movies/tenet-movie.jpg" alt="movie image" class="galery"/><br/>
            </div>

                <div class="contain">
                    <div>
                        <img src="../../images/movies/tenet.jpg" alt="movie image" class="movie-image"/><br/>
                    </div>
        
                    <div class="details">
                        <div class="mini-info">
                            <div class="hd"><b>HD</b></div>&nbsp;&nbsp;
                            <p class="pg"><b>PG-12</b></p>&nbsp;&nbsp;
                        ...
                        <p class="movie-description">Armed with only one word, Tenet, and fighting for the survival of the entire world, a Protagonist journeys through a twilight world of international espionage on a mission that will unfold in something beyond real time.</p>
                        <span>Genre: Action/Sci-fi</span><br/>
                        <span>Actors: Elizabeth Debicki, John David Washington, Robert Pattinson, Keneth Branagh...</span><br/>
                        <span>Director: Christopher Nolan</span><br/>
                        <span>Release: August 12, 2020</span><br/>
                    </div>
                    ...
                    <div class="extra-details">
                        ...
                        <hr/>
                        <a href="https://youtu.be/L3pk_TBkihU" target="_blank" title="Click to watch movie trailer"><button class="button">Trailer</button></a>
                    </div>
                </div>
