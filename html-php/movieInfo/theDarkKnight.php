...
<html>
    ...
    <body style="background-color: #030e16; color: white;">
        ...
        <div class="container-trui" id="header-parent-container">
            ...
            <div class="picture">
                <img src="../../images/movies/batman-movie-image.jpeg" alt="movie image" class="galery"/><br/>
            </div>

                <div class="contain">
                    <div>
                        <img src="../../images/movies/batman-rises.jpg" alt="movie image" class="movie-image"/><br/>
                    </div>
                    ...
                    <div class="details">
                        ...
                        <h2>Batman: The Dark Knight Rises</h2>
        
                        <p class="movie-description">Eight years after the Joker's reign of chaos, Batman is coerced out of exile with the assistance of the mysterious Selina Kyle in order to defend Gotham City from the vicious guerrilla terrorist Bane.</p>
                        <span>Genre: Action/Crime/Thriller</span><br/>
                        <span>Actors: Anne Hathaway, Tom Hardy, Christian Bale...</span><br/>
                        <span>Director: Christopher Nolan</span><br/>
                        <span>Release: July 25, 2012</span><br/>
                    </div>
                    ...
                    <div class="extra-details">
                        ...
                        <hr/>
                        <a href="https://youtu.be/g8evyE9TuYk" target="_blank" title="Click to watch movie trailer"><button class="button">Trailer</button></a>
                    </div>
                </div>
