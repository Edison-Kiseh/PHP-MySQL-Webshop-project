...
<html>
    ...
    <body style="background-color: #030e16; color: white;">
        ...
        <div class="container-trui" id="header-parent-container">
            ...
            <div class="picture">
                <img src="../../images/movies/the_man_from_uncle_landscape.jpg" alt="movie image" class="galery"/><br/>
            </div>

                <div class="contain">
                    <div>
                        <img src="../../images/movies/The_man_from_U.N.C.L.E.jpg" alt="movie image" class="movie-image"/><br/>
                    </div>
        
                    <div class="details">
                        <div class="mini-info">
                            <div class="hd"><b>HD</b></div>&nbsp;&nbsp;
                            <p class="pg"><b>PG-16</b></p>&nbsp;&nbsp;
                        ...
                        <p class="movie-description">Napoleon Solo, a CIA agent, and Illya Kuryakin, a KGB operative, must set aside their differences and work together to thwart the plans of a criminal organization that wants to use nuclear weapons.</p>
                        <span>Genre: Action/Adventure/Romance</span><br/>
                        <span>Actors: Armie Hammer, Henry Cavill, Alicia Vikander, Elizabeth Debicki...</span><br/>
                        <span>Director: Guy Ritchie</span><br/>
                        <span>Release: August 14, 2015</span><br/>
                    </div>
                    ...
                    <div class="extra-details">
                        ...
                        <hr/>
                        <a href="https://youtu.be/4K4Iv_N9Nno" target="_blank" title="Click to watch movie trailer"><button class="button">Trailer</button></a>
                    </div>
                </div>
