...
<html>
    <head>
        <meta charset="utf-8"/>
        <title>Mission Impossible: Dead reckoning</title>
    ...
    <body style="background-color: #030e16; color: white;">
        ...
        <div class="container-trui" id="header-parent-container">
            ...
            <div class="picture">
                <img src="../../images/movies/mission-impossible-filming-locations-4.jpg" alt="movie image" class="galery"/><br/>
            </div>

                <div class="contain">
                    <div>
                        <img src="../../images/movies/mission_impossible.jpg" alt="movie image" class="movie-image"/><br/>
                    </div>
                    ...
                    <div class="details">
                        ...
                        <h2>Mission Impossible: Death reckoning</h2>
        
                        <p class="movie-description">Ethan Hunt and the IMF team must track down a terrifying new weapon that threatens all of humanity if it falls into the wrong hands. With control of the future and the fate of the world at stake, a deadly race around the globe begins. Confronted by a mysterious, all-powerful enemy, Ethan is forced to consider that nothing can matter more than the mission -- not even the lives of those he cares about most.</p>
                        <span>Genre: Action/Thriller</span><br/>
                        <span>Actors: Tom Cruise, Hayley Atwell, Rebecca Ferguson, Esai Morales...</span><br/>
                        <span>Director: Christopher McQuarrie</span><br/>
                        <span>Release: July 12, 2023</span><br/>
                    </div>
                    ...
                    <div class="extra-details">
                        ...
                        <hr/>
                        <a href="https://youtu.be/avz06PDqDbM" target="_blank" title="Click to watch movie trailer"><button class="button">Trailer</button></a>
                    </div>
                </div>
