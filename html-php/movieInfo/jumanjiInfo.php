...
<html>
    ...
    <body style="background-color: #030e16; color: white;">
        ...
        <div class="container-trui" id="header-parent-container">
            ...
            <div class="picture">
                <img src="../../images/movies/jumanjiImage.jpg" alt="movie image" class="galery"/><br/>
            </div>

                <div class="contain">
                    <div>
                        <img src="../../images/movies/jumanji.jpg" alt="movie image" class="movie-image"/><br/>
                    </div>
                    ...
                    <div class="details">
                        ...
                        <p class="movie-description">When four students play with a magical video game, they are drawn to the jungle world of Jumanji, where they are trapped as their avatars. To return to the real world, they must finish the game.</p>
                        <span>Genre: Action/Adventure</span><br/>
                        <span>Actors: Dwayne Johnson, Kevin Hart, Karen Gillan...</span><br/>
                        <span>Director: Jake Kasdan</span><br/>
                        <span>Release: Dec 20, 2017</span><br/>
                    </div>
                    ...
                    <div class="extra-details">
                        ...
                        <hr/>
                        <a href="https://youtu.be/2QKg5SZ_35I" target="_blank" title="Click to watch movie trailer"><button class="button">Trailer</button></a>
                    </div>
                </div>
