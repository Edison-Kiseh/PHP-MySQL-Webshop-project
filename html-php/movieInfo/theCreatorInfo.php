...
<html>
    ...
    <body style="background-color: #030e16; color: white;">
        ...
        <div class="container-trui" id="header-parent-container">
            ...
            <div class="picture">
                <img src="../../images/movies/the-creator-image.jpeg" alt="movie image" class="galery"/><br/>
            </div>

                <div class="contain">
                    <div>
                        <img src="../../images/movies/the_creator.jpg" alt="movie image" class="movie-image"/><br/>
                    </div>
                    ...
                    <div class="details">
                        ...
                        <p class="movie-description">As a future war between the human race and artificial intelligence rages on, ex-special forces agent Joshua is recruited to hunt down and kill the Creator, the elusive architect of advanced AI. The Creator has developed a mysterious weapon that has the power to end the war and all of mankind. As Joshua and his team of elite operatives venture into enemy-occupied territory, they soon discover the world-ending weapon is actually an AI in the form of a young child.</p>
                        <span>Genre: Action/Sci-fi</span><br/>
                        <span>Actors: Gemma Chan, John David Washington, Madeleine Yuna Voyles...</span><br/>
                        <span>Director: Gareth Edwards</span><br/>
                        <span>Release: September 29, 2023</span><br/>
                    </div>
                    ...
                    <div class="extra-details">
                        ...
                        <hr/>
                        <a href="https://youtu.be/ex3C1-5Dhb8" target="_blank" title="Click to watch movie trailer"><button class="button">Trailer</button></a>
                    </div>
                </div>
