...
<html>
    ...
    <body style="background-color: #030e16; color: white;">
        ...
        <div class="container-trui" id="header-parent-container">
            ...
            <div class="picture">
                <img src="../../images/movies/mr_and_mrs_smith_movie.jpg" alt="movie image" class="galery"/><br/>
            </div>

                <div class="contain">
                    <div>
                        <img src="../../images/movies/mr_and_mrs_smith.jpeg" alt="movie image" class="movie-image"/><br/>
                    </div>
                    ...
                    <div class="details">
                        ...
                        <h2>Mr. and Mrs. Smith</h2>
        
                        <p class="movie-description">A husband and wife struggle to keep their marriage alive until they realise they are both secretly working as assassins. Now, their respective assignments require them to kill each other.</p>
                        <span>Genre: Action/Romance</span><br/>
                        <span>Actors: Brad Pitt, Angelina Jolie, Adam Brody...</span><br/>
                        <span>Director: Doug Liman</span><br/>
                        <span>Release: Jun 10, 2005</span><br/>
                    </div>
                    ...
                    <div class="extra-details">
                        ...
                        <hr/>
                        <a href="https://youtu.be/CZ0B22z22pI" target="_blank" title="Click to watch movie trailer"><button class="button">Trailer</button></a>
                    </div>
                </div>
